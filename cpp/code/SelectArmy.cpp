...
void CGameRes::Load() {
    ...
    for (const char *country_name : arr_country) {
        map_countryArmyImages[country_name].push_back(TextureRes_army.GetImageByFormat("InfantryD1905_%s.png", country_name));          // Infantry_D1905
        ...
        map_countryArmyImages[country_name].push_back(TextureRes_army.GetImageByFormat("heavytank_%s.png", country_name));        // MidTank_1916
