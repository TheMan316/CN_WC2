...
__END_DECLS
__sub_struct(GUIGold, GUIElement)
#ifdef __cplusplus
    void OnRender();
    void Init(const GUIRect &);
#ifdef extends_GUIGold
    extends_GUIGold
#endif
#endif
__end_struct
...
__BEGIN_DECLS
void _ZN7GUIGold8OnRenderEv(struct GUIGold *self);
void _ZN7GUIGold4InitERK7GUIRect(struct GUIGold *self, const struct GUIRect *);
__END_DECLS

__sub_struct(GUIBegin, GUIElement)
#ifdef __cplusplus
    void OnRender();
    void Init(const GUIRect &);
#ifdef extends_GUIBegin
    extends_GUIBegin
#endif
#endif
__end_struct
...
__BEGIN_DECLS
void _ZN8GUIBegin8OnRenderEv(struct GUIBegin *self);
void _ZN8GUIBegin4InitERK7GUIRect(struct GUIBegin *self, const struct GUIRect *);
__END_DECLS
...
private:
     std::map<ButtonType,GUIButton*> Map_newButton;
    void Add_newButton(ButtonType buttonType, GUIManager* instance);

public:
    void Add_newButtons(GUIManager * instance);
    GUIButton* Get_newButton(ButtonType buttonType);
    void Release();
};
